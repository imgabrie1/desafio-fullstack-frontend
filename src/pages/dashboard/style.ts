...
export const ContainerMainDiv = styled.div`
  ...
  box-shadow: rgba(0, 0, 0, 0.09) 0rem 0.125rem 0.0625rem, rgba(0, 0, 0, 0.09) 0rem 0.25rem 0.125rem,
    rgba(0, 0, 0, 0.09) 0rem 0.5rem 0.25rem, rgba(0, 0, 0, 0.09) 0rem 1rem 0.5rem,
...
export const ModalContainer = styled.div`
  ...
  .add-contact {
    ...
    button:nth-last-child(2) {
      background-color: transparent;
      border: 0.125rem solid var(--color-button);
      border-radius: 0.5rem;
    }
  }
